...
class AABBox
{
    ...
    friend bool isCollidingVertically(const AABBox &AABBox1, const AABBox &AABBox2);
    ...
    friend bool isCollidingVertically(const AABBox &AABBox1, const AABBox &AABBox2, const float &Threshold);
    ...
    friend bool isCollidingVerticallyRaw(const AABBox &AABBox1, const AABBox &AABBox2);
